...
DUNE::Tasks::Task* createAutonomyLineFollowTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createMonitorsLifeCycleTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSimulatorsMUGDetectionCameraTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSimulatorsUnderwaterAcousticsTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Factory::registerStaticTask("Autonomy.LineFollow", createAutonomyLineFollowTask);
...
DUNE::Tasks::Factory::registerStaticTask("Monitors.LifeCycle", createMonitorsLifeCycleTask);
...
DUNE::Tasks::Factory::registerStaticTask("Simulators.MUGDetectionCamera", createSimulatorsMUGDetectionCameraTask);
...
DUNE::Tasks::Factory::registerStaticTask("Simulators.UnderwaterAcoustics", createSimulatorsUnderwaterAcousticsTask);
